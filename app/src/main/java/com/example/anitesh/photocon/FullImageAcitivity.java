...
public class FullImageAcitivity extends AppCompatActivity implements View.OnTouchListener {
    final String TAG = "Touch";
    @SuppressWarnings("unused")
    final float MIN_ZOOM = 1f,MAX_ZOOM = 1f;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String bi = b.getString("id");
        String b3 = b.getString("screen");
        // Create an object for subclass of AsyncTask
        GetXMLTask task = new GetXMLTask();
        // Execute the task
        task.execute(new String[] { bi });
        img.setOnTouchListener(this);
            img2.setImageBitmap(adapter3.b1);
