...
public class CE extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fstyr = (RadioButton) findViewById(R.id.radioButton7);
        scndyr = (RadioButton) findViewById(R.id.radioButton9);
        thrdyr = (RadioButton) findViewById(R.id.radioButton8);
        frthyr = (RadioButton) findViewById(R.id.radioButton6);
